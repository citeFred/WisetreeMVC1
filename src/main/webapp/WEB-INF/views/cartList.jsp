          ...
          <table class="table table-striped">
             ...
             <!--    state.index:인덱스값(0~3)
                ...
                <tr>
                   <td>
                      <label>
                      <input type="checkbox" name="ItemNo" id="ItemNo${state.index}"
                       value="${cvo.ItemNo}">
                       ${cvo.ItemNo}
                      </label>
                   ...
                   <h4>${cvo.itemName}</h4>
                   <br>
                   <a href="../prodDetail?ItemNo=${cvo.ItemNo}" target="_blank">
                   <img src="../resources/product_images/${cvo.itemImage1}"
                    class="img-thumbnail" style="width:140px"></a>
                   </td>
                   <td>
                   <input type="number" name="count" id="count${state.index}"
                    value="${cvo.count}"  min="1" max="50" size="3">
                    <button type="button" class="btn btn-success"
                     onclick="cartEdit('${cvo.cartNo}','${state.index}')">
                     수정</button>
                   </td>
                   <td>
                   ...
                   <td>
                   <a  href="#" onclick="cartDel('${cvo.cartNo}')">삭제</a>
                   </td>
                </tr>  
                </c:forEach>
                </c:otherwise>        
